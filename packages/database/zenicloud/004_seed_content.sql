...
DROP POLICY IF EXISTS modules_public_read ON modules_catalog;
...
DROP POLICY IF EXISTS agent_catalog_public_read ON agent_catalog;
...
DROP TRIGGER IF EXISTS on_journey_created_seed_criteria ON ipo_journeys;
